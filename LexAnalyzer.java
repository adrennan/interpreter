...
public class LexAnalyzer
{
     ...
     */
    public LexAnalyzer(String fileName) throws FileNotFoundException, LexicalException
    {
        if (fileName == null)
        ...
        input.close();
        tokenList.add(new Token (TokenType.EOS_TOKEN, "EOS", lineNumber, 1));
    }
     ...
     * @param index >= 0
     * @return next lexeme
     * @throws IllegalArgumentException if line is null or line < 0
     */
